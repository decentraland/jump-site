...
import { Typography, IconButton } from 'decentraland-ui2'
...
import { StyledJumpInButton, JumpInIcon, ButtonContainer } from './JumpInButton.styled'
...
export const JumpInButton: FC<JumpInButtonProps> = ({ realm, position, onlyIcon = false, size = 'large' }) => {
  ...
  return (
    <>
      {onlyIcon ? (
        ...
        <ButtonContainer containerSize={size}>
          <StyledJumpInButton variant="contained" size={size} onMouseDown={handleClickJumpIn} buttonSize={size}>
            <>
              <Typography
                variant="body1"
                sx={theme => ({
